...
//   Date: Wed Aug 10 10:39:58 PDT 2022
//
...
(
  ...
  d2l_MASTER_CLK_SELECT_w,
  d2l_MASTER_CLK_SELECT_w_enable,
  d2l_MASTER_CLK_SELECT_we,
  d2l_MASTER_CLK_SELECT_re,
  ...
  l2h_MASTER_CLK_SELECT_SELECT_r );
  ...
  input     [31:0] d2l_MASTER_CLK_SELECT_w;
  input     [31:0] d2l_MASTER_CLK_SELECT_w_enable;
  input    d2l_MASTER_CLK_SELECT_we;
  input    d2l_MASTER_CLK_SELECT_re;
  ...
  output     [31:0] l2d_MASTER_CLK_SELECT_r;
  ...
  output    l2h_MASTER_CLK_SELECT_SELECT_r;
  ...
  reg  rg_MASTER_CLK_SELECT_SELECT;
  reg  reg_MASTER_CLK_SELECT_SELECT_next;
  reg  l2h_MASTER_CLK_SELECT_SELECT_r;
  reg   [31:0] l2d_MASTER_CLK_SELECT_r;
  ...
  //------- combinatorial assigns for MASTER_CLK_SELECT (pio read data)
  always @ (*) begin
    l2d_MASTER_CLK_SELECT_r = 32'b0;
    l2d_MASTER_CLK_SELECT_r [0]  = rg_MASTER_CLK_SELECT_SELECT;
  end
  ...
  //------- combinatorial assigns for MASTER_CLK_SELECT
  always @ (*) begin
    reg_MASTER_CLK_SELECT_SELECT_next = rg_MASTER_CLK_SELECT_SELECT;
    l2h_MASTER_CLK_SELECT_SELECT_r = rg_MASTER_CLK_SELECT_SELECT;
    if (d2l_MASTER_CLK_SELECT_we) reg_MASTER_CLK_SELECT_SELECT_next = ((d2l_MASTER_CLK_SELECT_w [0]  & d2l_MASTER_CLK_SELECT_w_enable [0] ) | (reg_MASTER_CLK_SELECT_SELECT_next & ~d2l_MASTER_CLK_SELECT_w_enable [0] ));
  end
  
  //------- reg assigns for MASTER_CLK_SELECT
  always @ (posedge clk or posedge reset) begin
    if (reset) begin
      rg_MASTER_CLK_SELECT_SELECT <= #1 1'b0;
    end
    else begin
      rg_MASTER_CLK_SELECT_SELECT <= #1  reg_MASTER_CLK_SELECT_SELECT_next;
    end
  end
