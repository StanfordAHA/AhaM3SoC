...
(
  ...
  wire   [31:0] d2l_MASTER_CLK_SELECT_w;
  wire   [31:0] d2l_MASTER_CLK_SELECT_w_enable;
  wire  d2l_MASTER_CLK_SELECT_we;
  wire  d2l_MASTER_CLK_SELECT_re;
  ...
  wire   [31:0] l2d_MASTER_CLK_SELECT_r;
  ...
  AhaPlatformCtrlAddrMap_jrdl_decode pio_decode (
    ...
    .l2d_MASTER_CLK_SELECT_r(l2d_MASTER_CLK_SELECT_r),
    ...
    .d2l_MASTER_CLK_SELECT_w(d2l_MASTER_CLK_SELECT_w),
    .d2l_MASTER_CLK_SELECT_w_enable(d2l_MASTER_CLK_SELECT_w_enable),
    .d2l_MASTER_CLK_SELECT_we(d2l_MASTER_CLK_SELECT_we),
    .d2l_MASTER_CLK_SELECT_re(d2l_MASTER_CLK_SELECT_re) );
