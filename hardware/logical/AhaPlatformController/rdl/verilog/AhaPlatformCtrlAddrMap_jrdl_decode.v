...
(
  ...
  input     [31:0] l2d_MASTER_CLK_SELECT_r;
  ...
  output     [31:0] d2l_MASTER_CLK_SELECT_w;
  output     [31:0] d2l_MASTER_CLK_SELECT_w_enable;
  output    d2l_MASTER_CLK_SELECT_we;
  output    d2l_MASTER_CLK_SELECT_re;
  ...
  reg   [31:0] d2l_MASTER_CLK_SELECT_w;
  reg   [31:0] d2l_MASTER_CLK_SELECT_w_enable;
  reg  d2l_MASTER_CLK_SELECT_we;
  reg  d2l_MASTER_CLK_SELECT_re;
  ...
  always @ (*) begin
    ...
    d2l_MASTER_CLK_SELECT_w = pio_dec_write_data_d1  [31:0] ;
    d2l_MASTER_CLK_SELECT_we = 1'b0;
    d2l_MASTER_CLK_SELECT_re = 1'b0;
    d2l_MASTER_CLK_SELECT_w_enable = pio_dec_write_enable_full  [31:0] ;
    ...
    //  Register: MASTER_CLK_SELECT     Address: 0x5c     External: false
    5'b10111:
      begin
        d2l_MASTER_CLK_SELECT_we = pio_write_active & ~dec_pio_ack;
        d2l_MASTER_CLK_SELECT_re = pio_read_active & ~dec_pio_ack;
        pio_internal_ack =  pio_read_active | pio_write_active;
        dec_pio_read_data_next  [31:0]  = l2d_MASTER_CLK_SELECT_r;
      end
    endcase
  end
