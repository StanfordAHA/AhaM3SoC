...
module AhaGarnetSoC #(
  ...
  AhaSoCPartialIntegration #(
    ...
    // MU
    .MU_REG_AWID                  (mu_reg_awid),
    .MU_REG_AWADDR                (mu_reg_awaddr),
    .MU_REG_AWLEN                 (mu_reg_awlen),
    .MU_REG_AWSIZE                (mu_reg_awsize),
    .MU_REG_AWBURST               (mu_reg_awburst),
    .MU_REG_AWLOCK                (mu_reg_awlock),
    .MU_REG_AWCACHE               (mu_reg_awcache),
    .MU_REG_AWPROT                (mu_reg_awprot),
    .MU_REG_AWVALID               (mu_reg_awvalid),
    .MU_REG_AWREADY               (mu_reg_awready),
    .MU_REG_WDATA                 (mu_reg_wdata),
    .MU_REG_WSTRB                 (mu_reg_wstrb),
    .MU_REG_WLAST                 (mu_reg_wlast),
    .MU_REG_WVALID                (mu_reg_wvalid),
    .MU_REG_WREADY                (mu_reg_wready),
    .MU_REG_BID                   (mu_reg_bid),
    .MU_REG_BRESP                 (mu_reg_bresp),
    .MU_REG_BVALID                (mu_reg_bvalid),
    .MU_REG_BREADY                (mu_reg_bready),
    .MU_REG_ARID                  (mu_reg_arid),
    .MU_REG_ARADDR                (mu_reg_araddr),
    .MU_REG_ARLEN                 (mu_reg_arlen),
    .MU_REG_ARSIZE                (mu_reg_arsize),
    .MU_REG_ARBURST               (mu_reg_arburst),
    .MU_REG_ARLOCK                (mu_reg_arlock),
    .MU_REG_ARCACHE               (mu_reg_arcache),
    .MU_REG_ARPROT                (mu_reg_arprot),
    .MU_REG_ARVALID               (mu_reg_arvalid),
    .MU_REG_ARREADY               (mu_reg_arready),
    .MU_REG_RID                   (mu_reg_rid),
    .MU_REG_RDATA                 (mu_reg_rdata),
    .MU_REG_RRESP                 (mu_reg_rresp),
    .MU_REG_RLAST                 (mu_reg_rlast),
    .MU_REG_RVALID                (mu_reg_rvalid),
    .MU_REG_RREADY                (mu_reg_rready),
